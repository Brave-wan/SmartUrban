...
public class InfoListAdapter extends CommonAdapter<String> {

    private Context context;

    public InfoListAdapter(@NonNull Context context, int layoutResId, @NonNull List<String> dataList) {
    ...
    protected void convert(BaseViewHolder baseViewHolder, String s, int position) {
        ...
        Glide.with(context).load("https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3586898888,816047016&fm=27&gp=0.jpg").into(img_info);
